    ...
    <div class="fillcontain">
        ...
        <div class="table_container" style="padding:20px;">
                        ...
                        <template slot-scope="props">
                            <el-form  label-position="left" inline class="demo-table-expand">
                                ...
                                <el-form-item label="样品图:" >
                                    <img width="80" v-for="(img, index)  in props.row.sample_imgs_final" :key="index" :src="img">
                                </el-form-item>
                                <el-form-item label="备注说明:" >
                                    <span>{{props.row.sample_info}}</span>
                                </el-form-item>
                                <el-form-item label="流程:" >
                                    <span v-for="(process, index)  in props.row.process" :key="index"><span v-if="index!=0">-></span>{{process.name}}</span>
                                </el-form-item>
                            </el-form>
                        </template>
                    </el-table-column>
                ...
                <div class="block" v-for="(sub_order, index)  in sub_orders" :key="index">
                        ...
                        <div style="display: inline-block;vertical-align: top">
                            <div style="margin-bottom: 3px;" v-for="(color, index2)  in sub_order.colors" :key="index2">
                                ...
                                <el-tooltip v-if="color.order_codes"  placement="top">
                                    <div slot="content">
                                        包含业务订单:<br/>
                                        <p v-for="(order_code, index)  in color.order_codes" :key="index">{{order_code}}</p>
                                    </div>
                                    <i class="iconfont">&#xe601;</i>
                                </el-tooltip>
                    ...
                    <div class="search_item">
                        <span class="pre_info" style="font-size: 14px;"><i style="color:red;">*</i>材料:
                          <el-tooltip v-if="sub_order.sales_order_sub_diff_data && sub_order.sales_order_sub_diff_data.length && sub_order.sales_order_sub_diff_data.length > 1"  placement="top">
                            <div slot="content">
                                <p v-for="(sub_sub_order, index)  in sub_order.sales_order_sub_diff_data" :key="index">
                                    订单{{index}}:
                                    <span v-if="sub_sub_order.material && sub_sub_order.material.length" v-for="(_material, index2) in sub_sub_order.material" :key="index2">
                        ...
                        <div style="display: inline-block;vertical-align: top">
                            <div style="margin-bottom: 3px;" v-for="(material, index2)  in sub_order.material" :key="index2">
                    ...
                    <div class="search_item">
                        <span class="pre_info" style="font-size: 14px;">装饰说明:<span>
                             <el-tooltip v-if="sub_order.sales_order_sub_diff_data && sub_order.sales_order_sub_diff_data.length && sub_order.sales_order_sub_diff_data.length > 1"  placement="top">
                            <div slot="content">
                                <p v-for="(sub_sub_order, index)  in sub_order.sales_order_sub_diff_data" :key="index" style="border-bottom: 1rpx dashed #999">
                    ...
                    <div class="search_item">
                        ...
                        <div style="display: inline-block;vertical-align: top">
                            <div style="margin-bottom: 3px;" v-for="(material_sub, index2)  in sub_order.material_sub" :key="index2">
                        ...
                        <span class="pre_info" style="font-size: 14px;">样品图片:
                          ...
                          <el-tooltip v-if="sub_order.sales_order_sub_diff_data && sub_order.sales_order_sub_diff_data.length && sub_order.sales_order_sub_diff_data.length > 1"  placement="top">
                            <div slot="content">
                                <p v-for="(sub_sub_order, index)  in sub_order.sales_order_sub_diff_data" :key="index">
                                    订单{{index}}:
                                    <span v-if="sub_sub_order.sample_imgs_final && sub_sub_order.sample_imgs_final.length" v-for="(img, index2) in sub_sub_order.sample_imgs_final" :key="index2">
            ...
            <div v-if="active == 2" class="table_container" style="text-align: center">
                <p>已成功生成如下订单:</p>
                <p v-for="(order, index)  in success_orders" :key="index">{{order.order_no}}</p>
